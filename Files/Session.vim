...
map <S-F10> \hlt
inoremap  u
noremap ó :set invspell spelllang=en_us|set spell?
let &cpo=s:cpo_save
unlet s:cpo_save
...
silent only
cd ~/overwolf_apps/adam_app/Files
...
badd +107 ~/.vimrc
badd +1 index.css
badd +30 ../../demo-app/Files/index.html
badd +12 ../../demo-app/manifest.json
args index.html
edit ../../demo-app/Files/index.html
...
exe 'vert 5resize ' . ((&columns * 159 + 119) / 239)
argglobal
let s:cpo_save=&cpo
set cpo&vim
let &cpo=s:cpo_save
